...
}// @description: Implements automatic Cross Origin Resource Sharing support using the XDomainRequest object for IE8 and IE9 
// when using the $.ajax function in jQuery 1.5+.
// @note: CORS requires the Access-Control-Allow-Origin header to be present in the AJAX response from the server.
